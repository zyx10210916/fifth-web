    ...
    <div class="template-form">
      ...
      <div class="form-row">
        <div class="form-item half-width">
          <label class="form-label">标签大类</label>
          <a-select
              v-model:value="formData.tagCategory"
              class="form-select"
              disabled
          >
        ...
        <div class="form-item half-width">
          <label class="form-label">标签中类</label>
          <a-select
              v-model:value="formData.tagSubCategory"
              class="form-select"
              disabled
          >
            <a-select-option value="xxx">xxx</a-select-option>
...
interface Emits {
  ...
  (e: 'save', data: { formData: TemplateFormData; metrics: any[]; formula?: string }): void;
  (e: 'cancel'): void;
}
